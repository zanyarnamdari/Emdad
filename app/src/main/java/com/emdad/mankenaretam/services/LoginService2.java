...
public class LoginService2 extends AppCompatActivity {

     static Register ctx;

    public LoginService2(Register ctx) {
        this.ctx = ctx;
    }

    public   void send(int a) throws JSONException, UnsupportedEncodingException {

        String urlLogin = Services.tempCode;
...
//
        ...
        if (!res2 ) {
            ...
            Toast.makeText(ctx, "کد امنیتی اشتباه وارد شده است ", Toast.LENGTH_SHORT).show();
